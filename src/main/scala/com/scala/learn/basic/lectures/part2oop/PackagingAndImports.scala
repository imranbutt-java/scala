...
import com.scala.learn.basic.playground.{Cinderalla => Princess, PrinceCharming}
...
object PackagingAndImports extends App {
  ...
  sayHello
  //import com.scala.learn.basic.playground.{Cinderalla, PrinceCharming}
  //If there is long list being imported it could be written as
  //import com.scala.learn.basic.playground._
  val prince = new PrinceCharming

  //Class aliases would be used
  //import com.scala.learn.basic.playground.{Cinderalla => Princess, PrinceCharming} and it is good, when more than
